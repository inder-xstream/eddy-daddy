          ...
          <div className="lg:col-span-12 space-y-4">
            ...
            <div className="px-4 sm:px-0 py-3 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-200 dark:border-dark-800">
                ...
                <div className="flex items-center gap-2 overflow-x-auto pb-2 sm:pb-0 no-scrollbar">
                   ...
                   />
                   <button className="flex items-center gap-2 px-4 py-2 rounded-full bg-gray-100 dark:bg-dark-800 hover:bg-gray-200 dark:hover:bg-dark-700 text-gray-700 dark:text-gray-300 transition-colors whitespace-nowrap">
