    ...
    <div className="h-full flex flex-col bg-white dark:bg-dark-900 border-r border-gray-200 dark:border-gray-800">
       <div className="p-4 flex-1 overflow-y-auto">
        ...
        <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-800">
          ...
          <Link
            href="/history"
            className={`flex items-center px-3 py-2 mt-1 text-sm rounded-lg transition-colors group ${
                pathname === '/history'
                ? 'bg-xred-500/10 text-xred-600 dark:text-xred-500 font-medium'
                : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-dark-800'
              }`}
          >
             <svg className="w-5 h-5 mr-2 text-gray-400 group-hover:text-xred-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
